...
export async function GET(request: NextRequest) {
  try {
    ...
    const demoImageUrl = await fetchImage('https://avatars.githubusercontent.com/u/10251060?s=200&v=4');

    const mockItems: Record<string, MediaItem[]> = {
        '1': [
            { id: 'a', title: 'Abbey Road', type: 'album', imageUrl: demoImageUrl},
            { id: 'b', title: 'Dark Side of the Moon', type: 'album', imageUrl: 'https://placehold.co/200x200/png' },
        ],
        '2': [
