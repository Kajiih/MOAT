...
Epic animations are fun animations that are triggered randomely when an item is moved from one tier to another. Those animations can take longer, use particles, etc.
