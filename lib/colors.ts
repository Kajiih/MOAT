...
export const COLOR_PALETTE: Record<string, ColorTheme> = {
  ...
  // emerald: { id: 'emerald', label: 'Emerald', bg: 'bg-emerald-500', text: 'text-emerald-500' },
  teal: { id: 'teal', label: 'Teal', bg: 'bg-teal-400', text: 'text-teal-400' },
  cyan: { id: 'cyan', label: 'Cyan', bg: 'bg-cyan-400', text: 'text-cyan-400' },
  // sky: { id: 'sky', label: 'Sky', bg: 'bg-sky-500', text: 'text-sky-500' },
  ...
  // violet: { id: 'violet', label: 'Violet', bg: 'bg-violet-500', text: 'text-violet-500' },
  purple: { id: 'purple', label: 'Purple', bg: 'bg-purple-500', text: 'text-purple-400' },
  // fuchsia: { id: 'fuchsia', label: 'Fuchsia', bg: 'bg-fuchsia-500', text: 'text-fuchsia-500' },
