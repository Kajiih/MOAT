...
export function SearchSettings({ fuzzyEnabled, wildcardEnabled, onFuzzyChange, onWildcardChange }: SearchSettingsProps) {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-64 bg-neutral-900 border border-neutral-700 rounded-lg shadow-xl p-4 z-50">
            ...
            <div className="space-y-3">
                ...
                <p className="text-[10px] text-neutral-500">
                    Finds matches even if you make spelling mistakes (e.g., &quot;micheal&quot; &rarr; &quot;Michael&quot;).
                </p>
                ...
                <p className="text-[10px] text-neutral-500">
                    Finds matches starting with your query (e.g., &quot;mic&quot; &rarr; &quot;Michael&quot;).
                </p>
            </div>
        </div>
      )}
