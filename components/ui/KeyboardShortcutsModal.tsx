            ...
            {shortcuts.map((s, i) => (
                <div key={i} className="flex justify-between items-center text-sm">
                    ...
                    <div className="flex gap-1">
                        {s.keys.map((k, j) => (
                            <kbd key={j} className="px-2 py-1 bg-neutral-800 rounded-md font-mono text-xs text-neutral-300 shadow-sm border border-neutral-700 min-w-[24px] text-center flex items-center justify-center">
