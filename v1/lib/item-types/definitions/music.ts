...
export const artistDefinition: ItemTypeDefinition<keyof MusicFilters> = {
  id: 'artist',
  category: 'music',
...
export const albumDefinition: ItemTypeDefinition<keyof MusicFilters> = {
  id: 'album',
  category: 'music',
...
export const songDefinition: ItemTypeDefinition<keyof MusicFilters> = {
  id: 'song',
  category: 'music',
