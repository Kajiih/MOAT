...
export const gameDefinition: ItemTypeDefinition<keyof GameFilters> = {
  id: 'game',
  category: 'game',
...
export const developerDefinition: ItemTypeDefinition<keyof GameFilters> = {
  id: 'developer',
  category: 'game',
...
export const franchiseDefinition: ItemTypeDefinition<keyof GameFilters> = {
  id: 'franchise',
  category: 'game',
