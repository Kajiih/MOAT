...
export const movieDefinition: ItemTypeDefinition<keyof CinemaFilters> = {
  id: 'movie',
  category: 'cinema',
...
export const tvDefinition: ItemTypeDefinition<keyof CinemaFilters> = {
  id: 'tv',
  category: 'cinema',
...
export const personDefinition: ItemTypeDefinition<keyof CinemaFilters> = {
  id: 'person',
  category: 'cinema',
