...
export const bookDefinition: ItemTypeDefinition<keyof BookFilters> = {
  id: 'book',
  category: 'book',
...
export const authorDefinition: ItemTypeDefinition<keyof BookFilters> = {
  id: 'author',
  category: 'book',
...
export const seriesDefinition: ItemTypeDefinition<keyof BookFilters> = {
  id: 'series',
  category: 'book',
