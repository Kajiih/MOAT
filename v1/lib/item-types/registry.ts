...
export class ItemTypeRegistry {
  private definitions = new Map<ItemType, ItemTypeDefinition>();
   ...
   */
  register(definition: ItemTypeDefinition): void {
   ...
   */
  registerMany(definitions: ItemTypeDefinition[]): void {
   ...
   */
  get(type: ItemType): ItemTypeDefinition {
   ...
   */
  getByCategory(category: BoardCategory): ItemTypeDefinition[] {
   ...
   */
  getFilter(type: ItemType, filterId: string): FilterConfig | undefined {
   ...
   */
  getSortOptions(type: ItemType): SortOptionConfig[] {
   ...
   */
  getDefaultFilters(type: ItemType): Record<string, unknown> {
   ...
   */
  getAllDefinitions(): ItemTypeDefinition[] {
