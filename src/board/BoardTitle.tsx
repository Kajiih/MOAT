...
export function BoardTitle({
  ...
  return (
    <textarea
      ...
      className={twMerge(
        baseStyles,
        'w-full resize-none overflow-hidden rounded-md bg-transparent px-2 py-1 focus:ring-2 focus:ring-primary focus:outline-none md:w-auto md:max-w-[600px] md:min-w-[300px]',
        className,
      )}
    />
  );
